...
# hidden Layer 1: 256 neurônios  → inicialização He + ativação ReLU (handout 06 -> he feita p relu)
# hidden Layer 2: 128 neurônios  → inicialização He + ativação ReLU
...
def inicializar_parametros(h1=256, h2=128):
...
# handout 6, seção 4.1: SGD - gradiente descente estocastico mini-batch de 64, 20 épocas, alpha = 0,05
